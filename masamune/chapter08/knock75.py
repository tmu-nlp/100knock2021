...
epo = [x for x in range(1, 11)]
#loss
ax1 = fig.add_subplot(2, 1, 1)
ax1.plot(epo, train_loss, marker='1', label = 'train')
ax1.plot(epo, valid_loss, marker='2', label='valid')
ax1.set_xlabel('epoch')
ax1.set_ylabel('loss')
plt.legend()
#accuracy
ax2 = fig.add_subplot(2, 1, 2)
ax2.plot(epo, train_acc, marker='1', label='train')
ax2.plot(epo, valid_acc, marker='2', label='valid')
