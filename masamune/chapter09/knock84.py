...
class RNN(nn.Module):
    def __init__(self, vocab_size, padding_idx, emb_size=300, output_size=4, hidden_size=50, emb_weights=None):
        super().__init__()
...
if __name__ == '__main__':
    ...
    model = RNN(vocab_size=vocab_size, padding_idx=padding_idx, emb_weights=weights)
